...
export interface WalletProvider {
	...
	topUpCard?(externalId: string, amount: number): Promise<{ balance: number; currency: Currency }>;
...
export class ProviderNotFoundError extends Error {
	...
	static suggestion =
		"Use 'wallets provider list' to see available providers, or 'wallets provider add' to register one.";
...
export class ProviderError extends Error {
	...
	static suggestion =
		"Check the provider configuration and API credentials. Run 'wallets doctor' for diagnostics.";
...
export class InsufficientFundsError extends Error {
	...
	static suggestion =
		'Fund the card with more money before making this transaction.';

	constructor(cardId: string, required: number, available: number) {
		super(
			`Insufficient funds on card ${cardId}: need ${required}, have ${available}`
		);
...
export class ConfigError extends Error {
	...
	static suggestion =
		'Check ~/.hasna/wallets/config.json and ensure all required fields are set.';
